                    ...
                    <div class="form-body">
                        <div class="form-column">
                            <div class="message-box">
                                ...
                                <p>Thank your for ordering with us and giving us the opportunity to serve you. Your order  for <br><a href="#">{{$entity_name}} {{ $entity_ending }}</a> has been received<br>and will notify you of your status soon.</p>
